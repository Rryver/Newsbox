...
const F_destCssDir = F_webDir_frontend + 'css/';
const F_destCssMinDir = F_webDir_frontend + 'css-min/';

const F_imagesDir = F_webDir_frontend + 'images/';
const F_jsDir = F_webDir_frontend + 'js/';
const F_fonts = F_webDir_frontend + 'fonts/';
const F_views = F_webDir_frontend + 'views/';

function browsersync() {
    browserSync.init({
        proxy: "localhost/Newsbox/frontend/web",
        browser: 'chrome',
    });
}
